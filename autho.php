<?php
    ...
    // Consumer key
    $conskey = '5c692a6dc9ba4255af2e161ee88f9d5e';

    // Consumer secret
    $conssec = '61db3631d84342ffa46c7725857c8805';

    // Fitbit API call (get activities for specified date)
    $apiCall = "http://api.fitbit.com/1/user/-/sleep/date/2014-08-14.json";
...
<html>
  ...
  <!-- Show activities on the page -->
   <!-- Unit System: <?php echo $xml->unitSystem ?><br />
    Active Score: <?php echo $xml->summary->startTime ?><br />
